  ...
  <div class="row justify-content-center">
    ...
    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
      <ul class="list-group list-group-flush" id="shop_side_menu">
        <li class="list-group-item list-group-item-action"><a href="{{ route('shop.index') }}" class="shop_links category_active">All Products</a></li>
    ...
    <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 shop_card">
